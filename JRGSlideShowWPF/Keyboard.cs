...
namespace JRGSlideShowWPF
{
    public partial class MainWindow : Window
    {
        ...
        private async Task DisplayFileInfo()
        {
            ...
            {
                InfoTextBoxClass.messageDisplayEndUninterruptable(new Action(() => { }));
        ...
        public void updateInfo()
        {
            ...
            if (ImageIdxListDeletePtr != -1 && ImageIdxList[ImageIdxListDeletePtr] != -1)
            {
                ...
                sb.Append(
                    ...
                    + "             Last Sleep Mode: " + (LastDisplayMode == 0 ? "Monitor can sleep." : "Monitor can not sleep.")
                    );

                InfoTextBoxClass.messageDisplayStart(sb.ToString(), -1, false, true);
            }
            else
            {
                displayingInfo = false;
